...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item"><a href="index.php?route=doctor_appointments" class="active">📅 Appointments</a></li>
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <p>Manage and track all scheduled patient sessions and consultations.</p>
        </div>

        <div class="card">
            <?php if (empty($appointments)): ?>
                <p style="color: #64748b; font-size: 14px; text-align: center; padding: 20px;">No appointments found.</p>
            <?php else: ?>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php foreach ($appointments as $app): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?route=manage_appointment&id=<?= $app['id'] ?>" class="btn-action">Manage &rarr;</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
