...
<html lang="en">
<head>
    <meta charset="UTF-8"><title>Messages | Doctor Portal</title>
    <style>
...
<body>
    ...
    <main class="main-content">
        <h2 style="margin-bottom: 20px;">✉️ Messages Workspace</h2>
        <div class="panel" style="text-align: center; padding: 80px 20px;">
            <div style="font-size: 60px; margin-bottom: 20px;">💬</div>
            <h3 style="color: #1e293b; margin-bottom: 10px; font-size: 22px;">Your inbox is ready!</h3>
            <p style="color: #64748b; max-width: 500px; margin: 0 auto; line-height: 1.6;">The live chat module database has not been initialized yet. Once connected, patients will be able to message you securely here.</p>
        </div>
    </main>
</body></html>